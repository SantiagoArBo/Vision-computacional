...
busqueda = True
#while busqueda:
#    img = cv2.imread('./imagenes/Banco_Pruebas/fotos/Posicion 1/Picture 1.jpg') #Imagen de baja calidad
#    img_busqueda = cv2.resize(img,(320,240), interpolation = cv2.INTER_AREA)
#    mensaje, busqueda = busquedaRepisa(img_busqueda)
#    print(mensaje)
img = cv2.imread('./imagenes/Banco_Pruebas/fotos/Posicion 2/Picture 13.jpg') #Imagen de baja calidad
